# Implements [Section 2.2.14 SMB2 CREATE Response](http://msdn.microsoft.com/en-us/library/cc246512.aspx)
# [Example 4.4 Executing an Operation on a Named Pipe](http://msdn.microsoft.com/en-us/library/cc246794.aspx)
class Smb2::Packet::CreateResponse < Smb2::Packet::Generic
