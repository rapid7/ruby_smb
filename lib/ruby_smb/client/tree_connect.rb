  ...
  class Client
    ...
    module TreeConnect
      ...
      def smb2_net_share_enum_all(file)
        ...
        #dce_rpc_query = "".strip.gsub(/([A-Fa-f0-9]{1,2})\s*?/) { $1.hex.chr }
        file.write(data: dce_rpc_query)
        read_data = file.read(bytes: 1024)
        ...
        #dce_rpc_query = "".strip.gsub(/([A-Fa-f0-9]{1,2})\s*?/) { $1.hex.chr }
